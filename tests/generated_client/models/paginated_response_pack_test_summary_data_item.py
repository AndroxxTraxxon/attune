...
T = TypeVar("T", bound="PaginatedResponsePackTestSummaryDataItem")



@_attrs_define
class PaginatedResponsePackTestSummaryDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_pack_test_summary_data_item = cls(
        ...
        paginated_response_pack_test_summary_data_item.additional_properties = d
        return paginated_response_pack_test_summary_data_item
