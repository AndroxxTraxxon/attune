...
if TYPE_CHECKING:
  from ..models.identity_role_assignment_response import IdentityRoleAssignmentResponse
...
class IdentityResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for direct_permissions_item_data in (_direct_permissions):
            direct_permissions_item = PermissionAssignmentResponse.from_dict(direct_permissions_item_data)
