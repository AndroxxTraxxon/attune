...
T = TypeVar("T", bound="PaginatedResponsePackSummaryDataItem")



@_attrs_define
class PaginatedResponsePackSummaryDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_pack_summary_data_item = cls(
            created=created,
            id=id,
            is_standard=is_standard,
            label=label,
        ...
        paginated_response_pack_summary_data_item.additional_properties = d
        return paginated_response_pack_summary_data_item
