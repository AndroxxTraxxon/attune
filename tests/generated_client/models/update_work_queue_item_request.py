...
if TYPE_CHECKING:
  ...
  from ..models.update_work_queue_item_request_metadata_type_0 import UpdateWorkQueueItemRequestMetadataType0
  from ..models.update_work_queue_item_request_payload_type_0 import UpdateWorkQueueItemRequestPayloadType0
...
class UpdateWorkQueueItemRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.update_work_queue_item_request_payload_type_0 import UpdateWorkQueueItemRequestPayloadType0
        d = dict(src_dict)
        def _parse_metadata(data: object) -> None | UpdateWorkQueueItemRequestMetadataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = UpdateWorkQueueItemRequestMetadataType0.from_dict(data)
        ...
        def _parse_payload(data: object) -> None | UpdateWorkQueueItemRequestPayloadType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
        ...
        def _parse_item_key(data: object) -> None | NullableStringPatchType1 | SetString | Unset:
            if data is None:
                return data
