...
T = TypeVar("T", bound="PaginatedResponseActionSummaryDataItem")



@_attrs_define
class PaginatedResponseActionSummaryDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_action_summary_data_item = cls(
            created=created,
            description=description,
            entrypoint=entrypoint,
            id=id,
        ...
        paginated_response_action_summary_data_item.additional_properties = d
        return paginated_response_action_summary_data_item
