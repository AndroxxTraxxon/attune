...
T = TypeVar("T", bound="PaginatedResponseSensorSummaryDataItem")



@_attrs_define
class PaginatedResponseSensorSummaryDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_sensor_summary_data_item = cls(
            created=created,
            description=description,
            enabled=enabled,
            id=id,
        ...
        paginated_response_sensor_summary_data_item.additional_properties = d
        return paginated_response_sensor_summary_data_item
