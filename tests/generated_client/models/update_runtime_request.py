...
if TYPE_CHECKING:
  ...
  from ..models.update_runtime_request_distributions_type_0 import UpdateRuntimeRequestDistributionsType0
  from ..models.update_runtime_request_execution_config_type_0 import UpdateRuntimeRequestExecutionConfigType0
...
class UpdateRuntimeRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.update_runtime_request_execution_config_type_0 import UpdateRuntimeRequestExecutionConfigType0
        d = dict(src_dict)
        def _parse_distributions(data: object) -> None | UpdateRuntimeRequestDistributionsType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                distributions_type_0 = UpdateRuntimeRequestDistributionsType0.from_dict(data)
        ...
        def _parse_execution_config(data: object) -> None | UpdateRuntimeRequestExecutionConfigType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                execution_config_type_0 = UpdateRuntimeRequestExecutionConfigType0.from_dict(data)
        ...
        def _parse_installation(data: object) -> None | NullableJsonPatchType1 | SetJson | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_nullable_json_patch_type_1 = NullableJsonPatchType1.from_dict(data)
