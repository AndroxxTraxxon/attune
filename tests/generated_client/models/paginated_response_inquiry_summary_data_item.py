...
T = TypeVar("T", bound="PaginatedResponseInquirySummaryDataItem")



@_attrs_define
class PaginatedResponseInquirySummaryDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_inquiry_summary_data_item = cls(
            created=created,
            execution=execution,
            has_response=has_response,
            id=id,
        ...
        paginated_response_inquiry_summary_data_item.additional_properties = d
        return paginated_response_inquiry_summary_data_item
