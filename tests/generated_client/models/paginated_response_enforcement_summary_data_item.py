...
T = TypeVar("T", bound="PaginatedResponseEnforcementSummaryDataItem")



@_attrs_define
class PaginatedResponseEnforcementSummaryDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_enforcement_summary_data_item = cls(
            condition=condition,
            created=created,
            id=id,
            rule_ref=rule_ref,
        ...
        paginated_response_enforcement_summary_data_item.additional_properties = d
        return paginated_response_enforcement_summary_data_item
