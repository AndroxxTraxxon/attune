...
T = TypeVar("T", bound="PaginatedResponseTriggerSummaryDataItem")



@_attrs_define
class PaginatedResponseTriggerSummaryDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_trigger_summary_data_item = cls(
            created=created,
            enabled=enabled,
            id=id,
            label=label,
        ...
        paginated_response_trigger_summary_data_item.additional_properties = d
        return paginated_response_trigger_summary_data_item
